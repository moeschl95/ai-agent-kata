 ...
 *
 * Provides OpenAPI 3.0 specification metadata, enabling automatic Swagger UI generation
 * and external API documentation generation via tools like OpenAPI Generator.
 */
@Configuration
