...
public class ProjectionService {
  ...
  /**
   * Projects the state of a single item after the given number of days. The original item is not
   * modified.
   *
  ...
  public ItemDto project(final Item item, final int days) {
    ...
    return new ItemDto(
        ...
        pricingService.priceFor(projectedItem));
  }

  /**
   * Projects the state of all items in the given list after the given number of days. The original
