...
/**
 * Default implementation of {@link PricingService} that computes prices based on a configurable
 * base-price map, an expired item discount rate, and a special legendary price.
 */
public class DefaultPricingService implements PricingService {
  ...
  public DefaultPricingService(
      final Map<String, Integer> basePrices,
      final double expiredDiscountRate,
      final int legendaryPrice) {
   ...
   * {@inheritDoc}
   *
   * <p>Legendary items always return the legendary price. Expired items receive a discount.
   */
  @Override
