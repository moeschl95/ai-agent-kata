 ...
 *
 * <p>Verifies that the /v3/openapi.json endpoint returns a valid OpenAPI specification and confirms
 * that all ShopController endpoints are documented.
 */
@SpringBootTest
...
class OpenApiIntegrationTest {
  ...
  void should_containApiDescription_when_openApiSpecIsGenerated() throws Exception {
    mockMvc
        ...
        .andExpect(
            jsonPath("$.info.description", containsString("REST API for managing Gilded Rose")));
  }
