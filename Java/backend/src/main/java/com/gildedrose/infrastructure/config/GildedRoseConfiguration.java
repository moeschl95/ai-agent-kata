 ...
 *
 * <p>Reads pricing configuration from application properties and creates the {@link
 * PricingService}, {@link GildedRose} (domain use case), and wires the repository adapter beans.
 */
@Configuration
