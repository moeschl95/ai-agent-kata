...
class GildedRoseTest {
  ...
  void should_increaseQualityByTwo_when_conjuredBackstagePassHasMoreThanTenDays() {
    // Arrange
    List<Item> items =
        List.of(new Item("Conjured Backstage passes to a TAFKAL80ETC concert", 15, 20));
    GildedRose app = new GildedRose(items);
    // Act
    app.updateQuality();
    // Assert
  ...
  void should_increaseQualityByFour_when_conjuredBackstagePassHasTenDaysOrLess() {
    // Arrange
    List<Item> items =
        List.of(new Item("Conjured Backstage passes to a TAFKAL80ETC concert", 10, 20));
    GildedRose app = new GildedRose(items);
    // Act
    app.updateQuality();
    // Assert
  ...
  void should_increaseQualityBySix_when_conjuredBackstagePassHasFiveDaysOrLess() {
    // Arrange
    List<Item> items =
        List.of(new Item("Conjured Backstage passes to a TAFKAL80ETC concert", 5, 20));
    GildedRose app = new GildedRose(items);
    // Act
    app.updateQuality();
    // Assert
  ...
  void should_dropQualityToZero_when_conjuredBackstagePassSellInIsExpired() {
    // Arrange
    List<Item> items =
        List.of(new Item("Conjured Backstage passes to a TAFKAL80ETC concert", 0, 20));
    GildedRose app = new GildedRose(items);
    // Act
    app.updateQuality();
    // Assert
  ...
  void should_notIncreaseAbove50_when_conjuredBackstagePassQualityIsNearMax() {
    // Arrange
    List<Item> items =
        List.of(new Item("Conjured Backstage passes to a TAFKAL80ETC concert", 10, 48));
    GildedRose app = new GildedRose(items);
    // Act
    app.updateQuality();
    // Assert
  ...
  void should_notIncreaseAbove50_when_conjuredBackstagePassQualityIsNearMaxWithFiveDaysRemaining() {
    // Arrange
    List<Item> items =
        List.of(new Item("Conjured Backstage passes to a TAFKAL80ETC concert", 5, 47));
    GildedRose app = new GildedRose(items);
    // Act
    app.updateQuality();
    // Assert
